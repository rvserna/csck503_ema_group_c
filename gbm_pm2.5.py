"""HistGradientBoostingRegressor model to predict PM2.5 emissions"""
...
# Specify the target variable (PM2.5 only)
label = "total_pollutant_pm2.5_2019"

# Features (X) will be all columns except the label (PM2.5) and grid_id
...
print(f"Mean Squared Error for PM2.5: {mse:.2f}")
print(f"R-squared for PM2.5: {r2:.2f}")

# Create a visualization of Actual vs Predicted for PM2.5

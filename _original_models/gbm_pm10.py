"""HistGradientBoostingRegressor model to predict PM10 emissions"""
...
# Specify the target variable (PM10 only)
label = "total_pollutant_pm10_2019"

# Features (X) will be all columns except the label (PM10) and grid_id
...
print(f"Mean Squared Error for PM10: {mse:.2f}")
print(f"R-squared for PM10: {r2:.2f}")

# Create a visualization of Actual vs Predicted for PM10

"""Random Forest model to predict NOX emissions"""
...
assert 'total_pollutant_nox_2019' in data_cleaned.columns, "Target variable not found in the dataset."

# Separate features (X) and target variable (y)
X = data_cleaned.drop(columns=['total_pollutant_nox_2019'])
y = data_cleaned['total_pollutant_nox_2019']
...
plt.ylabel('Feature')
plt.title('Top 10 Important Features in Predicting NOX Pollution')
...
plt.title('Actual vs Predicted NOX Values')
plt.grid(True)
plt.show()

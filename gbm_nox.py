"""HistGradientBoostingRegressor model to predict NOx emissions"""
...
print(f"Mean Squared Error for NOx: {mse:.2f}")
print(f"R-squared for NOx: {r2:.2f}")

# Create a visualization of Actual vs Predicted for NOx
